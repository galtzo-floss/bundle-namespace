...
gem_version =
  if RUBY_VERSION >= "3.1" # rubocop:disable Gemspec/RubyVersionGlobalsUsage
    ...
    Module.new.tap { |mod| Kernel.load("#{__dir__}/lib/bundle/namespace/version.rb", mod) }::Bundle::Namespace::Version::VERSION
  else
    ...
    require "bundle/namespace/version"
...
Gem::Specification.new do |spec|
  ...
  # The 'git' gem is optional; bundle-namespace falls back to shelling out to `git` if it is not present.
